...
if(!defined('_M_RETORNO_CBR643')) {
	define('_M_RETORNO_CBR643',true);
	
	class MRetornoCBR643 extends MRetornoBanco {
		/**
		 * Header
		 */
		protected $agencia;
		...
		public function processa() {
			...
			while( !feof($fd) ) {
				...
				if( strlen(trim($linha)) ) {
					...
					//echo "SEQ REGISTRO.: [" . $seq_registro . "]\n";
					//echo "-----------------------------------------\n";
