 ...
 * @version    CVS: $Id: mimage_barcode_int25.class.php,v 1.3 2006/09/05 12:18:35 mosman Exp $
 ...
 * @link       http://pear.php.net/package/Image_Barcode
 */
class MImage_Barcode_int25 extends Image_Barcode
{
    /**
     * Barcode type
     * @var string
     ...
     * @param  string $target	Save the image at target
     *
    ...
    function draw($text, $imgtype = 'png', $target='')
    {
